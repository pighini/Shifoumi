        ...
        <div class="col-md-12 col-xs-12">
            ...
            <div class="col-md-9 col-xs-9" style="background-color: #2a2b2b; color: white; height: 800px;">
                <div class="col-md-12 col-xs-12" style="background-color: #1b2021; color: black; border: 1px; height: 560px; margin-top: 20px;">
                    <canvas style="border: 1px;"></canvas>
                </div>

                <div class="col-md-12 col-xs-12" style="background-color: #1b2021; margin-top: 20px; height: 180px;">
                    <ul class="nav nav-pills">
                        <li><a data-toggle="pill" href="#onePoint" style="color: white; text-decoration: none;" onmouseover="this.style.color = 'white'; this.style.background = '#419222';" onmouseout="this.style.color = 'white'; this.style.background = 'none'">One point bet</a></li>
                        <li><a data-toggle="pill" href="#game" style="color: white; text-decoration: none;" onmouseover="this.style.color = 'white'; this.style.background = '#419222';" onmouseout="this.style.color = 'white'; this.style.background = 'none'">Game bet</a></li>
                    </ul>

                    <div class="tab-content">
                        <div id="onePoint" class="tab-pane fade in active">
                            <form method="post">
                                <fieldset>
